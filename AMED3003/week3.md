...
**What it is**: Non-ionising imaging that uses magnetic fields and radiofrequency
waves.
...
**How it works**: Iodine contrast injected into vessels → X-ray images taken before
